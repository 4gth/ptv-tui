...
RoutesOneOrMoreRoutesParams contains all the parameters to send to the API endpoint
	...
	for the routes one or more routes operation.
...
// WithDefaults hydrates default values in the routes one or more routes params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *RoutesOneOrMoreRoutesParams) WithDefaults() *RoutesOneOrMoreRoutesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the routes one or more routes params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *RoutesOneOrMoreRoutesParams) SetDefaults() {
...
// bindParamRoutesOneOrMoreRoutes binds the parameter route_types
func (o *RoutesOneOrMoreRoutesParams) bindParamRouteTypes(formats strfmt.Registry) []string {
