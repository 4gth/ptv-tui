...
DisruptionsGetDisruptionByIDParams contains all the parameters to send to the API endpoint
	...
	for the disruptions get disruption by Id operation.
...
// WithDefaults hydrates default values in the disruptions get disruption by Id params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DisruptionsGetDisruptionByIDParams) WithDefaults() *DisruptionsGetDisruptionByIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the disruptions get disruption by Id params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DisruptionsGetDisruptionByIDParams) SetDefaults() {
