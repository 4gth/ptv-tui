...
DisruptionsGetDisruptionsByRouteParams contains all the parameters to send to the API endpoint
	...
	for the disruptions get disruptions by route operation.
...
// WithDefaults hydrates default values in the disruptions get disruptions by route params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DisruptionsGetDisruptionsByRouteParams) WithDefaults() *DisruptionsGetDisruptionsByRouteParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the disruptions get disruptions by route params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DisruptionsGetDisruptionsByRouteParams) SetDefaults() {
