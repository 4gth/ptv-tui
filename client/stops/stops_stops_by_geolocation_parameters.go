...
StopsStopsByGeolocationParams contains all the parameters to send to the API endpoint
	...
	for the stops stops by geolocation operation.
...
// WithDefaults hydrates default values in the stops stops by geolocation params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StopsStopsByGeolocationParams) WithDefaults() *StopsStopsByGeolocationParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the stops stops by geolocation params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StopsStopsByGeolocationParams) SetDefaults() {
...
// bindParamStopsStopsByGeolocation binds the parameter route_types
func (o *StopsStopsByGeolocationParams) bindParamRouteTypes(formats strfmt.Registry) []string {
