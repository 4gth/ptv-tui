...
// New creates a new stops API client with basic auth credentials.
...
// New creates a new stops API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
type ClientService interface {
	StopsStopDetails(params *StopsStopDetailsParams, opts ...ClientOption) (*StopsStopDetailsOK, error)

	StopsStopsByGeolocation(params *StopsStopsByGeolocationParams, opts ...ClientOption) (*StopsStopsByGeolocationOK, error)

	StopsStopsForRoute(params *StopsStopsForRouteParams, opts ...ClientOption) (*StopsStopsForRouteOK, error)
...
*/
func (a *Client) StopsStopDetails(params *StopsStopDetailsParams, opts ...ClientOption) (*StopsStopDetailsOK, error) {
...
*/
func (a *Client) StopsStopsByGeolocation(params *StopsStopsByGeolocationParams, opts ...ClientOption) (*StopsStopsByGeolocationOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) StopsStopsForRoute(params *StopsStopsForRouteParams, opts ...ClientOption) (*StopsStopsForRouteOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
