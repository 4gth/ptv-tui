...
DeparturesGetForStopAndRouteParams contains all the parameters to send to the API endpoint
	...
	for the departures get for stop and route operation.
...
// WithDefaults hydrates default values in the departures get for stop and route params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeparturesGetForStopAndRouteParams) WithDefaults() *DeparturesGetForStopAndRouteParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the departures get for stop and route params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeparturesGetForStopAndRouteParams) SetDefaults() {
...
func (o *DeparturesGetForStopAndRouteParams) WithExpand(expand []int32) *DeparturesGetForStopAndRouteParams {
	o.SetExpand(expand)
	return o
}

// SetExpand adds the expand to the departures get for stop and route params
func (o *DeparturesGetForStopAndRouteParams) SetExpand(expand []int32) {
	o.Expand = expand
}
...
// WithIncludeGeopath adds the includeGeopath to the departures get for stop and route params
func (o *DeparturesGetForStopAndRouteParams) WithIncludeGeopath(includeGeopath *bool) *DeparturesGetForStopAndRouteParams {
	o.SetIncludeGeopath(includeGeopath)
	return o
}

// SetIncludeGeopath adds the includeGeopath to the departures get for stop and route params
func (o *DeparturesGetForStopAndRouteParams) SetIncludeGeopath(includeGeopath *bool) {
...
// bindParamDeparturesGetForStopAndRoute binds the parameter expand
func (o *DeparturesGetForStopAndRouteParams) bindParamExpand(formats strfmt.Registry) []string {
	expandIR := o.Expand
