...
SearchSearchParams contains all the parameters to send to the API endpoint
	...
	for the search search operation.
...
// WithDefaults hydrates default values in the search search params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SearchSearchParams) WithDefaults() *SearchSearchParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the search search params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SearchSearchParams) SetDefaults() {
...
// bindParamSearchSearch binds the parameter route_types
func (o *SearchSearchParams) bindParamRouteTypes(formats strfmt.Registry) []string {
