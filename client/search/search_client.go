...
type ClientService interface {
	SearchSearch(params *SearchSearchParams, opts ...ClientOption) (*SearchSearchOK, error)
...
*/
func (a *Client) SearchSearch(params *SearchSearchParams, opts ...ClientOption) (*SearchSearchOK, error) {
