...
DirectionsForDirectionParams contains all the parameters to send to the API endpoint
	...
	for the directions for direction operation.
...
// WithDefaults hydrates default values in the directions for direction params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DirectionsForDirectionParams) WithDefaults() *DirectionsForDirectionParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the directions for direction params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DirectionsForDirectionParams) SetDefaults() {
