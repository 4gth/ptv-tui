...
DirectionsForRouteParams contains all the parameters to send to the API endpoint
	...
	for the directions for route operation.
...
// WithDefaults hydrates default values in the directions for route params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DirectionsForRouteParams) WithDefaults() *DirectionsForRouteParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the directions for route params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DirectionsForRouteParams) SetDefaults() {
