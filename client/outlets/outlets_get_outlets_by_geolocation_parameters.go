...
OutletsGetOutletsByGeolocationParams contains all the parameters to send to the API endpoint
	...
	for the outlets get outlets by geolocation operation.
...
// WithDefaults hydrates default values in the outlets get outlets by geolocation params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *OutletsGetOutletsByGeolocationParams) WithDefaults() *OutletsGetOutletsByGeolocationParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the outlets get outlets by geolocation params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *OutletsGetOutletsByGeolocationParams) SetDefaults() {
