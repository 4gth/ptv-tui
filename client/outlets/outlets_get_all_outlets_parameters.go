...
OutletsGetAllOutletsParams contains all the parameters to send to the API endpoint
	...
	for the outlets get all outlets operation.
...
// WithDefaults hydrates default values in the outlets get all outlets params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *OutletsGetAllOutletsParams) WithDefaults() *OutletsGetAllOutletsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the outlets get all outlets params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *OutletsGetAllOutletsParams) SetDefaults() {
