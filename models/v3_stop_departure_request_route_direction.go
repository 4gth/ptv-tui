...
// ContextValidate validates this v3 stop departure request route direction based on context it is used
func (m *V3StopDepartureRequestRouteDirection) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
