		...
		if m.RouteDirections[i] != nil {
			if err := m.RouteDirections[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("route_directions" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *V3StopDepartureRequest) validateRouteTypeEnum(path, location string, value int32) error {
	if err := validate.EnumCase(path, location, value, v3StopDepartureRequestTypeRouteTypePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
// ContextValidate validate this v3 stop departure request based on the context it is used
func (m *V3StopDepartureRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateRouteDirections(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *V3StopDepartureRequest) contextValidateRouteDirections(ctx context.Context, formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.RouteDirections); i++ {
		...
		if m.RouteDirections[i] != nil {
			...
			if err := m.RouteDirections[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("route_directions" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("route_directions" + "." + strconv.Itoa(i))
