...
// V3RouteWithStatus v3 route with status
//
// swagger:model V3.RouteWithStatus
...
func (m *V3RouteWithStatus) validateRouteServiceStatus(formats strfmt.Registry) error {
	...
	if m.RouteServiceStatus != nil {
		if err := m.RouteServiceStatus.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("route_service_status")
			}
			return err
		}
	}
...
// ContextValidate validate this v3 route with status based on the context it is used
func (m *V3RouteWithStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateRouteServiceStatus(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *V3RouteWithStatus) contextValidateRouteServiceStatus(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.RouteServiceStatus != nil {
		...
		if err := m.RouteServiceStatus.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("route_service_status")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("route_service_status")
