	...
	if m.StopAccessibility != nil {
		if err := m.StopAccessibility.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("stop_accessibility")
			}
			return err
		}
	}
	...
	if m.StopAmenities != nil {
		if err := m.StopAmenities.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("stop_amenities")
			}
			return err
		}
	}
	...
	if m.StopLocation != nil {
		if err := m.StopLocation.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("stop_location")
			}
			return err
		}
	}
	...
	if m.StopStaffing != nil {
		if err := m.StopStaffing.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("stop_staffing")
			}
			return err
		}
	}
...
// ContextValidate validate this v3 stop details based on the context it is used
func (m *V3StopDetails) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateStopAccessibility(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateStopAmenities(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateStopLocation(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateStopStaffing(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *V3StopDetails) contextValidateStopAccessibility(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.StopAccessibility != nil {
		...
		if err := m.StopAccessibility.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("stop_accessibility")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("stop_accessibility")
...
func (m *V3StopDetails) contextValidateStopAmenities(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.StopAmenities != nil {
		...
		if err := m.StopAmenities.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("stop_amenities")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("stop_amenities")
...
func (m *V3StopDetails) contextValidateStopLocation(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.StopLocation != nil {
		...
		if err := m.StopLocation.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("stop_location")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("stop_location")
...
func (m *V3StopDetails) contextValidateStopStaffing(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.StopStaffing != nil {
		...
		if err := m.StopStaffing.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("stop_staffing")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("stop_staffing")
