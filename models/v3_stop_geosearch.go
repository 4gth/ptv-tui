...
// ContextValidate validates this v3 stop geosearch based on context it is used
func (m *V3StopGeosearch) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
