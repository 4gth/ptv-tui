...
// ContextValidate validates this v3 stop staffing based on context it is used
func (m *V3StopStaffing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
