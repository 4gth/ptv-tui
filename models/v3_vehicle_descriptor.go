...
// ContextValidate validates this v3 vehicle descriptor based on context it is used
func (m *V3VehicleDescriptor) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
