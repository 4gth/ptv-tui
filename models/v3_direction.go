...
// ContextValidate validates this v3 direction based on context it is used
func (m *V3Direction) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
