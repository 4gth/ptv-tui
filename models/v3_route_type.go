...
// ContextValidate validates this v3 route type based on context it is used
func (m *V3RouteType) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
