...
// ContextValidate validates this v3 direction with description based on context it is used
func (m *V3DirectionWithDescription) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
