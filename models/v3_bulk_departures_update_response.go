	...
	if m.RequestedRouteDirection != nil {
		if err := m.RequestedRouteDirection.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("requested_route_direction")
			}
			return err
		}
	}
	...
	if m.RouteDirection != nil {
		if err := m.RouteDirection.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("route_direction")
			}
			return err
		}
	}
...
func (m *V3BulkDeparturesUpdateResponse) validateRouteDirectionStatusEnum(path, location string, value int32) error {
	if err := validate.EnumCase(path, location, value, v3BulkDeparturesUpdateResponseTypeRouteDirectionStatusPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
// ContextValidate validate this v3 bulk departures update response based on the context it is used
func (m *V3BulkDeparturesUpdateResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
	...
	if err := m.contextValidateRequestedRouteDirection(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateRouteDirection(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *V3BulkDeparturesUpdateResponse) contextValidateDepartures(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V3BulkDeparturesUpdateResponse) contextValidateRequestedRouteDirection(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.RequestedRouteDirection != nil {
		...
		if err := m.RequestedRouteDirection.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("requested_route_direction")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("requested_route_direction")
...
func (m *V3BulkDeparturesUpdateResponse) contextValidateRouteDirection(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.RouteDirection != nil {
		...
		if err := m.RouteDirection.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("route_direction")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("route_direction")
