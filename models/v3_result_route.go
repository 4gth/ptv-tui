...
// ContextValidate validate this v3 result route based on the context it is used
func (m *V3ResultRoute) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V3ResultRoute) contextValidateRouteServiceStatus(ctx context.Context, formats strfmt.Registry) error {
