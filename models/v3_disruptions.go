		...
		if m.Ferry[i] != nil {
			if err := m.Ferry[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("ferry" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.General[i] != nil {
			if err := m.General[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("general" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.InterstateTrain[i] != nil {
			if err := m.InterstateTrain[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("interstate_train" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.NightBus[i] != nil {
			if err := m.NightBus[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("night_bus" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.SchoolBus[i] != nil {
			if err := m.SchoolBus[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("school_bus" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.Skybus[i] != nil {
			if err := m.Skybus[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("skybus" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.Taxi[i] != nil {
			if err := m.Taxi[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("taxi" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.Telebus[i] != nil {
			if err := m.Telebus[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("telebus" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
// ContextValidate validate this v3 disruptions based on the context it is used
func (m *V3Disruptions) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateFerry(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateInterstateTrain(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateNightBus(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateSchoolBus(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateSkybus(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateTaxi(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateTelebus(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *V3Disruptions) contextValidateFerry(ctx context.Context, formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.Ferry); i++ {
		...
		if m.Ferry[i] != nil {
			...
			if err := m.Ferry[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("ferry" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("ferry" + "." + strconv.Itoa(i))
...
func (m *V3Disruptions) contextValidateGeneral(ctx context.Context, formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.General); i++ {
		...
		if m.General[i] != nil {
			...
			if err := m.General[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("general" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("general" + "." + strconv.Itoa(i))
...
func (m *V3Disruptions) contextValidateInterstateTrain(ctx context.Context, formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.InterstateTrain); i++ {
		...
		if m.InterstateTrain[i] != nil {
			...
			if err := m.InterstateTrain[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("interstate_train" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("interstate_train" + "." + strconv.Itoa(i))
...
func (m *V3Disruptions) contextValidateMetroBus(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V3Disruptions) contextValidateMetroTrain(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V3Disruptions) contextValidateMetroTram(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V3Disruptions) contextValidateNightBus(ctx context.Context, formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.NightBus); i++ {
		...
		if m.NightBus[i] != nil {
			...
			if err := m.NightBus[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("night_bus" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("night_bus" + "." + strconv.Itoa(i))
...
func (m *V3Disruptions) contextValidateRegionalBus(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V3Disruptions) contextValidateRegionalCoach(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V3Disruptions) contextValidateRegionalTrain(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V3Disruptions) contextValidateSchoolBus(ctx context.Context, formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.SchoolBus); i++ {
		...
		if m.SchoolBus[i] != nil {
			...
			if err := m.SchoolBus[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("school_bus" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("school_bus" + "." + strconv.Itoa(i))
...
func (m *V3Disruptions) contextValidateSkybus(ctx context.Context, formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.Skybus); i++ {
		...
		if m.Skybus[i] != nil {
			...
			if err := m.Skybus[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("skybus" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("skybus" + "." + strconv.Itoa(i))
...
func (m *V3Disruptions) contextValidateTaxi(ctx context.Context, formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.Taxi); i++ {
		...
		if m.Taxi[i] != nil {
			...
			if err := m.Taxi[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("taxi" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("taxi" + "." + strconv.Itoa(i))
...
func (m *V3Disruptions) contextValidateTelebus(ctx context.Context, formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.Telebus); i++ {
		...
		if m.Telebus[i] != nil {
			...
			if err := m.Telebus[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("telebus" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("telebus" + "." + strconv.Itoa(i))
