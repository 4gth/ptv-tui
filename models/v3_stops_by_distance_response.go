...
// ContextValidate validate this v3 stops by distance response based on the context it is used
func (m *V3StopsByDistanceResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V3StopsByDistanceResponse) contextValidateDisruptions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V3StopsByDistanceResponse) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V3StopsByDistanceResponse) contextValidateStops(ctx context.Context, formats strfmt.Registry) error {
