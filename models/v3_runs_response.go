...
// ContextValidate validate this v3 runs response based on the context it is used
func (m *V3RunsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V3RunsResponse) contextValidateRuns(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V3RunsResponse) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
