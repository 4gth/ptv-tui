...
func (m *V3Status) validateHealthEnum(path, location string, value int32) error {
	if err := validate.EnumCase(path, location, value, v3StatusTypeHealthPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
// ContextValidate validates this v3 status based on context it is used
func (m *V3Status) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
