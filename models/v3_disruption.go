...
// ContextValidate validate this v3 disruption based on the context it is used
func (m *V3Disruption) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V3Disruption) contextValidateRoutes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V3Disruption) contextValidateStops(ctx context.Context, formats strfmt.Registry) error {
