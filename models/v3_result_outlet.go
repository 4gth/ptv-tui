...
// V3ResultOutlet v3 result outlet
//
// swagger:model V3.ResultOutlet
...
// ContextValidate validates this v3 result outlet based on context it is used
func (m *V3ResultOutlet) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
