	...
	if m.Wheelchair != nil {
		if err := m.Wheelchair.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("wheelchair")
			}
			return err
		}
	}
...
// ContextValidate validate this v3 stop accessibility based on the context it is used
func (m *V3StopAccessibility) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateWheelchair(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *V3StopAccessibility) contextValidateWheelchair(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.Wheelchair != nil {
		...
		if err := m.Wheelchair.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("wheelchair")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("wheelchair")
