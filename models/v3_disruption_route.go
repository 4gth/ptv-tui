...
// ContextValidate validate this v3 disruption route based on the context it is used
func (m *V3DisruptionRoute) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V3DisruptionRoute) contextValidateDirection(ctx context.Context, formats strfmt.Registry) error {
