...
func (m *V3DeparturesSpecificParameters) validateExpandItemsEnum(path, location string, value int32) error {
	if err := validate.EnumCase(path, location, value, v3DeparturesSpecificParametersExpandItemsEnum, true); err != nil {
		return err
	}
	return nil
}
...
// ContextValidate validates this v3 departures specific parameters based on context it is used
func (m *V3DeparturesSpecificParameters) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
