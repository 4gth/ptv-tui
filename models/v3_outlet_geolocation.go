...
// ContextValidate validates this v3 outlet geolocation based on context it is used
func (m *V3OutletGeolocation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
