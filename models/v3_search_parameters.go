...
func (m *V3SearchParameters) validateRouteTypesItemsEnum(path, location string, value int32) error {
	if err := validate.EnumCase(path, location, value, v3SearchParametersRouteTypesItemsEnum, true); err != nil {
		return err
	}
	return nil
}
...
// ContextValidate validates this v3 search parameters based on context it is used
func (m *V3SearchParameters) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
